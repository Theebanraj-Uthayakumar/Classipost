...
1. Logo
  - `<a href="Admin_index2" class="logo">` moved & rebuild to `.brand-link` inside `.main-sidebar`
2. Header / Nav
...
2. Logo / Brand Link
  - `<a href="Admin_index3" class="brand-link"><img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"><span class="brand-text font-weight-light">AdminLTE 3</span></a>` replaces the old logo
3. Sidebar
