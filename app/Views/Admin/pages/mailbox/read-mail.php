          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../Admin_read_mail" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Read</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-3">
              <a href="Admin_mailbox" class="btn btn-primary btn-block mb-3">Back to Inbox</a>
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-footer bg-white">
                  <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
                    ...
                    <li>
                      <span class="mailbox-attachment-icon has-img"><img src="Admin_P/dist/img/photo1.png" alt="Attachment"></span>
                    ...
                    <li>
                      <span class="mailbox-attachment-icon has-img"><img src="Admin_P/dist/img/photo2.png" alt="Attachment"></span>
