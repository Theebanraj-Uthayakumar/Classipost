...
<head>
  ...
  <!-- jsGrid -->
  <link rel="stylesheet" href="Admin_P/plugins/jsgrid/jsgrid.min.css">
  <link rel="stylesheet" href="Admin_P/plugins/jsgrid/jsgrid-theme.min.css">
  <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="Admin_jsgrid" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>jsGrid</p>
                  </a>
                </li>
  ...
  <!-- jsGrid -->
  <script src="Admin_P/plugins/jsgrid/demos/db.js"></script>
  <script src="Admin_P/plugins/jsgrid/jsgrid.min.js"></script>
  <!-- AdminLTE App -->
