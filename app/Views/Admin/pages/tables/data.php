...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="Admin_P/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="Admin_P/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
  <link rel="stylesheet" href="Admin_P/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
  <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="Admin_data" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>DataTables</p>
                  </a>
                </li>
  ...
  <!-- DataTables  & Plugins -->
  <script src="Admin_P/plugins/datatables/jquery.dataTables.min.js"></script>
  <script src="Admin_P/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js"></script>
  <script src="Admin_P/plugins/datatables-responsive/js/dataTables.responsive.min.js"></script>
  <script src="Admin_P/plugins/datatables-responsive/js/responsive.bootstrap4.min.js"></script>
  <script src="Admin_P/plugins/datatables-buttons/js/dataTables.buttons.min.js"></script>
  <script src="Admin_P/plugins/datatables-buttons/js/buttons.bootstrap4.min.js"></script>
  <script src="Admin_P/plugins/jszip/jszip.min.js"></script>
  <script src="Admin_P/plugins/pdfmake/pdfmake.min.js"></script>
  <script src="Admin_P/plugins/pdfmake/vfs_fonts.js"></script>
  <script src="Admin_P/plugins/datatables-buttons/js/buttons.html5.min.js"></script>
  <script src="Admin_P/plugins/datatables-buttons/js/buttons.print.min.js"></script>
  <script src="Admin_P/plugins/datatables-buttons/js/buttons.colVis.min.js"></script>
  <!-- AdminLTE App -->
