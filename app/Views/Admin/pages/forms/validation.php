...
<body class="hold-transition sidebar-mini">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../Admin_validation" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Validation</p>
                  </a>
                </li>
  ...
  <!-- jquery-validation -->
  <script src="Admin_P/plugins/jquery-validation/jquery.validate.min.js"></script>
  <script src="Admin_P/plugins/jquery-validation/additional-methods.min.js"></script>
  <!-- AdminLTE App -->
