...
<head>
  ...
  <!-- CodeMirror -->
  <link rel="stylesheet" href="Admin_P/plugins/codemirror/codemirror.css">
  <link rel="stylesheet" href="Admin_P/plugins/codemirror/theme/monokai.css">
  <!-- SimpleMDE -->
  <link rel="stylesheet" href="Admin_P/plugins/simplemde/simplemde.min.css">
</head>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../Admin_editors" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Editors</p>
                  </a>
                </li>
...
<div class="info-box bg-gradient-info">
  ...
  <!-- CodeMirror -->
  <script src="Admin_P/plugins/codemirror/codemirror.js"></script>
  <script src="Admin_P/plugins/codemirror/mode/css/css.js"></script>
  <script src="Admin_P/plugins/codemirror/mode/xml/xml.js"></script>
  <script src="Admin_P/plugins/codemirror/mode/htmlmixed/htmlmixed.js"></script>
