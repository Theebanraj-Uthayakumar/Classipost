...
<head>
    ...
    <!-- uPlot -->
    <link rel="stylesheet" href="Admin_P/plugins/uplot/uPlot.min.css">
    <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="Admin_P/Admin_index3" class="brand-link">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="Admin_chartjs" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>uPlot</p>
                                    </a>
                                </li>
    ...
    <!-- uPlot -->
    <script src="Admin_P/plugins/uplot/uPlot.iife.min.js"></script>
    <!-- AdminLTE App -->
