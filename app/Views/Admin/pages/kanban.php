...
<head>
    ...
    <!-- Ekko Lightbox -->
    <link rel="stylesheet" href="Admin_P/plugins/ekko-lightbox/ekko-lightbox.css">
    <!-- Theme style -->
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="Admin_kanban" class="nav-link active">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="examples/contact-us" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Contact us</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="Admin_P/Admin_iframe" class="nav-link">
    ...
    <!-- Ekko Lightbox -->
    <script src="Admin_P/plugins/ekko-lightbox/ekko-lightbox.min.js"></script>
    <!-- overlayScrollbars -->
    ...
    <!-- Filterizr-->
    <script src="Admin_P/plugins/filterizr/jquery.filterizr.min.js"></script>
