...
<head>
  ...
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href="Admin_P/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
  <!-- Toastr -->
  <link rel="stylesheet" href="Admin_P/plugins/toastr/toastr.min.css">
  <!-- Theme style -->
...
<body class="hold-transition sidebar-mini">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="Admin_modals" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Modals & Alerts</p>
                  </a>
                </li>
  ...
  <!-- SweetAlert2 -->
  <script src="Admin_P/plugins/sweetalert2/sweetalert2.min.js"></script>
  <!-- Toastr -->
  <script src="Admin_P/plugins/toastr/toastr.min.js"></script>
  <!-- AdminLTE App -->
    ...
    $(function() {
      ...
      $('.toastsDefaultFullImage').click(function() {
        $(document).Toasts('create', {
          ...
          title: 'Toast Title',
          subtitle: 'Subtitle',
          image: 'Admin_P/dist/img/user3-128x128.jpg',
