...
<head>
  ...
  <!-- Ion Slider -->
  <link rel="stylesheet" href="Admin_P/plugins/ion-rangeslider/css/ion.rangeSlider.min.css">
  <!-- bootstrap slider -->
  <link rel="stylesheet" href="Admin_P/plugins/bootstrap-slider/css/bootstrap-slider.min.css">
  <!-- Theme style -->
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="Admin_sliders" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Sliders</p>
                  </a>
                </li>
