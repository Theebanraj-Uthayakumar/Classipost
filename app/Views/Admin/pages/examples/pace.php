...
<head>
  ...
  <!-- pace-progress -->
  <link rel="stylesheet" href="Admin_P/plugins/pace-progress/themes/black/pace-theme-flat-top.css">
  <!-- adminlte-->
...
<body class="hold-transition sidebar-mini pace-primary">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="Admin_pace" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Pace</p>
                  </a>
                </li>
  ...
  <!-- pace-progress -->
  <script src="Admin_P/plugins/pace-progress/pace.min.js"></script>
  <!-- AdminLTE App -->
