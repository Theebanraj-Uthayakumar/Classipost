               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="Admin_e_commerce" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>E-commerce</p>
                                    </a>
                                </li>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                ...
                                <div class="col-12">
                                    <img src="Admin_P/dist/img/prod-1.jpg" class="product-image" alt="Product Image">
                                </div>
                                <div class="col-12 product-image-thumbs">
                                    <div class="product-image-thumb active"><img src="Admin_P/dist/img/prod-1.jpg" alt="Product Image"></div>
                                    <div class="product-image-thumb"><img src="Admin_P/dist/img/prod-2.jpg" alt="Product Image"></div>
                                    <div class="product-image-thumb"><img src="Admin_P/dist/img/prod-3.jpg" alt="Product Image"></div>
                                    <div class="product-image-thumb"><img src="Admin_P/dist/img/prod-4.jpg" alt="Product Image"></div>
                                    <div class="product-image-thumb"><img src="Admin_P/dist/img/prod-5.jpg" alt="Product Image"></div>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
