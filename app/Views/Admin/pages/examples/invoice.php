        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="Admin_invoice" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Invoice</p>
                  </a>
                </li>
              ...
              <div class="invoice p-3 mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    ...
                    <img src="Admin_P/dist/img/credit/visa.png" alt="Visa">
                    <img src="Admin_P/dist/img/credit/mastercard.png" alt="Mastercard">
                    <img src="Admin_P/dist/img/credit/american-express.png" alt="American Express">
                    <img src="Admin_P/dist/img/credit/paypal2.png" alt="Paypal">
                ...
                <div class="row no-print">
                  <div class="col-12">
                    <a href="Admin_invoice_print" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
