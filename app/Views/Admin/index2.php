...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__wobble" src="Admin_P/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
        </div>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="Admin_index2" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v2</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="pages/kanban" class="nav-link">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                            <ul class="users-list clearfix">
                                                <li>
                                                    <img src="Admin_P/dist/img/user1-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Alexander Pierce</a>
                                                    <span class="users-list-date">Today</span>
                                                </li>
                                                <li>
                                                    <img src="Admin_P/dist/img/user8-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Norman</a>
                                                    <span class="users-list-date">Yesterday</span>
                                                </li>
                                                <li>
                                                    <img src="Admin_P/dist/img/user7-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Jane</a>
                                                    <span class="users-list-date">12 Jan</span>
                                                </li>
                                                <li>
                                                    <img src="Admin_P/dist/img/user6-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">John</a>
                                                    <span class="users-list-date">12 Jan</span>
                                                </li>
                                                <li>
                                                    <img src="Admin_P/dist/img/user2-160x160.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Alexander</a>
                                                    <span class="users-list-date">13 Jan</span>
                                                </li>
                                                <li>
                                                    <img src="Admin_P/dist/img/user5-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Sarah</a>
                                                    <span class="users-list-date">14 Jan</span>
                                                </li>
                                                <li>
                                                    <img src="Admin_P/dist/img/user4-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Nora</a>
                                                    <span class="users-list-date">15 Jan</span>
                                                </li>
                                                <li>
                                                    <img src="Admin_P/dist/img/user3-128x128.jpg" alt="User Image">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><a href="Admin_invoice">OR9842</a></td>
                                                ...
                                                <tr>
                                                    <td><a href="Admin_invoice">OR1848</a></td>
                                                ...
                                                <tr>
                                                    <td><a href="Admin_invoice">OR7429</a></td>
                                                    <td>iPhone 6 Plus</td>
                                    ...
                                    <ul class="products-list product-list-in-card pl-2 pr-2">
                                        <li class="item">
                                            <div class="product-img">
                                                <img src="Admin_P/dist/img/default-150x150.png" alt="Product Image" class="img-size-50">
                                            </div>
    ...
    <!-- PAGE PLUGINS -->
    <!-- jQuery Mapael -->
    <script src="Admin_P/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
    <script src="Admin_P/plugins/raphael/raphael.min.js"></script>
    <script src="Admin_P/plugins/jquery-mapael/jquery.mapael.min.js"></script>
    <script src="Admin_P/plugins/jquery-mapael/maps/usa_states.min.js"></script>
    <!-- ChartJS -->
    ...
    <script src="Admin_P/dist/js/pages/dashboard2.js"></script>
</body>
