...
<head>
    ...
    <link rel="stylesheet" href="Admin_P/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    <link rel="stylesheet" href="Admin_P/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- JQVMap -->
    <link rel="stylesheet" href="Admin_P/plugins/jqvmap/jqvmap.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="Admin_P/dist/css/adminlte.min.css">
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="Admin_P/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="Admin_P/plugins/daterangepicAdmin_widgetsker/daterangepicker.css">
    <!-- summernote -->
    <link rel="stylesheet" href="Admin_P/plugins/summernote/summernote-bs4.min.css">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="Admin_P/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
        </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="pages/Admin_collapsed_sidebar" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="Admin_timeline" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Timeline</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="Admin_projects" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Projects</p>
                                    </a>
                                </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="Admin_P/dist/img/user1-128x128.jpg" alt="message user image">
                                            <!-- /.direct-chat-img -->
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="Admin_P/dist/img/user3-128x128.jpg" alt="message user image">
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="Admin_P/dist/img/user1-128x128.jpg" alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="Admin_P/dist/img/user7-128x128.jpg" alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="Admin_P/dist/img/user3-128x128.jpg" alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="Admin_P/dist/img/user5-128x128.jpg" alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="Admin_P/dist/img/user6-128x128.jpg" alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="Admin_P/dist/img/user8-128x128.jpg" alt="User Avatar">
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="Admin_P/plugins/jquery-ui/jquery-ui.min.js"></script>
    ...
    <!-- ChartJS -->
    <script src="Admin_P/plugins/chart.js/Chart.min.js"></script>
    <!-- Sparkline -->
    <script src="Admin_P/plugins/sparklines/sparkline.js"></script>
    <!-- JQVMap -->
    <script src="Admin_P/plugins/jqvmap/jquery.vmap.min.js"></script>
    <script src="Admin_P/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
    <!-- jQuery Knob Chart -->
    <script src="Admin_P/plugins/jquery-knob/jquery.knob.min.js"></script>
    <!-- daterangepicker -->
    <script src="Admin_P/plugins/moment/moment.min.js"></script>
    <script src="Admin_P/plugins/daterangepicker/daterangepicker.js"></script>
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="Admin_P/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
    <!-- Summernote -->
    <script src="Admin_P/plugins/summernote/summernote-bs4.min.js"></script>
    <!-- overlayScrollbars -->
    <script src="Admin_P/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
    <!-- AdminLTE App -->
    <script src="Admin_P/dist/js/adminlte.js"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="Admin_P/dist/js/demo.js"></script>
    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="Admin_P/dist/js/pages/dashboard.js"></script>
</body>
