                ...
                <div class="sidebar-item-box">
                    <div class="gradient-wrapper">
                        ...
                        <ul class="sidebar-sell-quickly">
                            <li><a href="faq">Use a brief title and description of the item.</a></li>
                            <li><a href="faq">Make sure you post in the correct category</a></li>
                            <li><a href="faq">Add nice photos to your ad</a></li>
                            <li><a href="faq">Put a reasonable price</a></li>
                            <li><a href="faq">Check the item before publish</a></li>
                        </ul>
                    </div>
                </div>
            </div>
